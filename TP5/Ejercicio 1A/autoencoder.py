...
class Autoencoder:
    def __init__(self, layers, activation_fn_name, loss_fn_name, optimizer, learning_rate, initial_lr=None, decay_rate=None, variable_lr=False, seed=None, init_method="xavier"):
        self.layers = layers
