...
files = ['struct_0.02.csv', 'struct_0.05.csv', 'struct_0.005.csv']
simulation_names = ['Estructura of 0.02', 'Estructura of 0.05', 'Estructura of 0.005']
...
ax.set_title('Fitness Range of Last Generation per Simulation for Different Stop Criteria for Structure', fontsize=16)
