...
files = ['offs_20_yb.csv', 'offs_50_yb.csv', 'offs_150_yb.csv']
simulation_names = ['Offspring Count 20', 'Offspring Count 50', 'Offspring Count 150']
...
ax.set_title('Fitness Range of Last Generation per Simulation for Different Offspring Count with Young Bias', fontsize=16)
...
ax.legend(loc='upper left', bbox_to_anchor=(1, 0.3))  # Mover la leyenda más abajo, ajustando 'bbox_to_anchor'
